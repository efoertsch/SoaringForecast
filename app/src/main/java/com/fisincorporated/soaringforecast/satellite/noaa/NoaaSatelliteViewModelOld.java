...
public class NoaaSatelliteViewModelOld extends BaseObservable implements ViewModelLifeCycle {

    private static final String TAG = NoaaSatelliteViewModelOld.class.getSimpleName();
    ...
    @Inject
    NoaaSatelliteViewModelOld() {
    }

    public NoaaSatelliteViewModelOld setView(View view) {
