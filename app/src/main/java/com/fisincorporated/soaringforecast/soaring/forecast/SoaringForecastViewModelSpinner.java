...
public class SoaringForecastViewModelSpinner extends AndroidViewModel {
    ...
    public SoaringForecastViewModelSpinner(@NonNull Application application) {
        super(application);
    }

    public SoaringForecastViewModelSpinner setAppRepository(AppRepository appRepository) {
        this.appRepository = appRepository;
        return this;
    }

    public SoaringForecastViewModelSpinner setAppPreferences(AppPreferences appPreferences) {
        this.appPreferences = appPreferences;
        return this;
    }

    public SoaringForecastViewModelSpinner setSoaringForecastDownloader(SoaringForecastDownloader soaringForecastDownloader) {
    ...
    /**
     * For the selected region (currently just "New England") and for each date is list
